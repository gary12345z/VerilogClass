...
`timescale 1ns/10ps
`define CLK_period 4                // CLK period. DO NOT modify period
`define SDFFILE "./huffman_syn_dft.sdf"  // Modify your sdf file name
...
initial begin
$fsdbDumpfile("huffman_dft.fsdb");
$fsdbDumpvars;
end


huffman u_huffman(.clk(CLK), .reset(reset), .gray_valid(gray_valid), .gray_data(gray_data), .test_se(1'b0), 
    .CNT_valid(CNT_valid), 
