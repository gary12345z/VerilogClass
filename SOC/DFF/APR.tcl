...
# 8. Floorplan
create_floorplan -flip_first_row
# 9. Place Macro and Standard Cells
...
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -add_point {-0.250 0.000} -scale 0.1252
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -add_point {-0.125 107.010} -scale 0.1252
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -add_point {-0.125 -0.250} -scale 0.1252
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -add_point {110.640 -0.375} -scale 0.1252
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -abort
# 13. Add power strap *4
create_power_straps  -direction vertical  -start_at 30 -nets  {VDD VSS}  -layer METAL4 -width 1 -extend_for_multiple_connections  -extension_gap 16
create_power_straps  -direction vertical  -start_at 80.000 -nets  {VDD VSS}  -layer METAL4 -width 1 -extend_for_multiple_connections  -extension_gap 16
create_power_straps  -direction horizontal  -start_at 30 -nets  {VDD VSS}  -layer METAL5 -width 1 -extend_for_multiple_connections  -extension_gap 16
create_power_straps  -direction horizontal  -start_at 80.000 -nets  {VDD VSS}  -layer METAL5 -width 1 -extend_for_multiple_connections  -extension_gap 16
# 14. CTS (report)
check_physical_design -stage pre_place_opt > ./report/CTS_report.txt
check_physical_design -stage pre_clock_opt >> ./report/CTS_report.txt
report_constraint -all >> ./report/CTS_report.txt
clock_opt -optimize_dft -fix_hold_all_clocks -no_clock_route >> ./report/CTS_report.txt
# 15. route
